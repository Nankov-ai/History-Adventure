...
// Unit keys: A1-A2 (Geografia), B1-B4 e C1-C3 (História)
...
const gameData = {
  ...
  peninsulaLocalizacao: {
    ...
    matchWords: {
      ...
      'Oceano Atlântico': '⛵',
      'Mar Mediterrâneo': '<svg viewBox="0 0 100 100" style="width:80%;height:80%"><circle cx="50" cy="38" r="22" fill="#FFA500"/><g stroke="#FFA500" stroke-width="6" stroke-linecap="round"><line x1="50" y1="4" x2="50" y2="12"/><line x1="18" y1="20" x2="24" y2="25"/><line x1="82" y1="20" x2="76" y2="25"/></g><path d="M0,62 Q15,52 30,62 Q45,72 60,62 Q75,52 90,62 Q95,64 100,62 L100,100 L0,100 Z" fill="#1a6fc4"/><path d="M0,72 Q15,64 30,72 Q45,80 60,72 Q75,64 90,72 Q95,74 100,72 L100,100 L0,100 Z" fill="#0d4f96"/></svg>',
      'Pirenéus': '⛰️',
    ...
    translations: {
      ...
      'rosa dos ventos': 'esquema com os pontos cardeais e colaterais que nos ajuda a orientar num mapa',
      'norte': 'também se chama Setentrião — fica para cima no mapa',
      'sul': 'também se chama Meridião — fica para baixo no mapa',
      'este': 'também se chama Oriente, Nascente ou Levante — é por onde o Sol nasce',
      'oeste': 'também se chama Ocidente ou Poente — é por onde o Sol se põe',
    },
    quizQuestions: [
      ...
      { question: 'Como se chama o esquema com os pontos cardeais que nos ajuda a orientar num mapa?', options: ['Rosa dos Ventos', 'Escala', 'Legenda', 'Título'], correct: 0, emoji: '🧭', hint: 'Tem o Norte, o Sul, o Este e o Oeste.' },
      { question: 'Como também se pode chamar o ponto cardeal Este?', options: ['Oriente', 'Ocidente', 'Setentrião', 'Meridião'], correct: 0, emoji: '🧭', hint: 'É por onde o Sol nasce.' },
    ],
    unscrambleWords: [
      ...
      { scrambled: 'ETNRO', answer: 'norte', emoji: '🧭', hint: 'Também se chama Setentrião.' },
    ],
    completeSentences: [
      ...
      { sentence: 'A Península está rodeada pelo Oceano Atlântico e pelo Mar Mediterrâneo, e a norte tem as montanhas dos ___.', blank: 'Pirenéus', options: ['Pirenéus', 'Alpes', 'Andes', 'Himalaias'], emoji: '⛰️', hint: 'São montanhas que separam a Península da França.' },
      ...
      { sentence: 'O ponto cardeal Oeste também se pode chamar Ocidente ou ___.', blank: 'Poente', options: ['Poente', 'Nascente', 'Setentrião', 'Meridião'], emoji: '🧭', hint: 'É por onde o Sol se põe.' },
    ],
    mapLabels: [
      { term: 'Título', definition: 'Indica o tema ou o assunto do mapa.' },
      { term: 'Legenda', definition: 'Explica o significado das cores e dos sinais convencionais que aparecem no mapa.' },
      { term: 'Escala', definition: 'Indica o tamanho real do que foi representado — pode ser gráfica (um segmento de reta) ou numérica (uma fração, como 1/10000).' },
      { term: 'Orientação', definition: 'A Rosa dos Ventos, com os pontos cardeais (N, S, E, O) e colaterais (NE, NO, SE, SO), que nos ajuda a orientar no mapa.' },
      { term: 'Fonte', definition: 'Indica quem fez o mapa ou de onde vêm os dados representados.' },
    ],
  },
  ...
  primeirasComunidades: {
    ...
    completeSentences: [
      { sentence: 'Quem vivia na Península há muito, muito tempo tirava da Natureza tudo o que comia: eram ___.', blank: 'recoletores', options: ['recoletores', 'agricultores', 'romanos', 'comerciantes'], emoji: '🏹', hint: 'Recolhiam frutos, caçavam e pescavam.' },
      { sentence: 'Quando começaram a cultivar a terra e a criar animais, as pessoas deixaram de andar de um lado para o outro e ficaram ___.', blank: 'sedentários', options: ['sedentários', 'nómadas', 'viajantes', 'exploradores'], emoji: '🏠', hint: 'O oposto de nómada.' },
  ...
  romanos: {
    ...
    quizQuestions: [
      ...
      { question: 'Qual foi o imperador romano que fez do cristianismo a religião oficial?', options: ['Teodósio', 'Constantino', 'Nero', 'Adriano'], correct: 0, emoji: '✝️', hint: 'Isto aconteceu em 380, depois de Constantino.' },
    ...
    completeSentences: [
      { sentence: 'Os Romanos chegaram à Península em 218 a.C., mas os ___ lutaram muito contra eles.', blank: 'Lusitanos', options: ['Lusitanos', 'Visigodos', 'Celtas', 'Mouros'], emoji: '🗡️', hint: 'Povo peninsular famoso pela sua resistência.' },
  ...
  muculmanos: {
    ...
    quizQuestions: [
      ...
      { question: 'Onde é visível a herança dos Muçulmanos na Península?', options: ['Em monumentos, em palavras e na agricultura', 'Apenas na comida', 'Apenas na roupa', 'Nada restou'], correct: 0, emoji: '🏺', hint: 'Pensa em palavras portuguesas que começam por "al-".' },
    ],
    unscrambleWords: [
    ...
    completeSentences: [
      ...
      { sentence: 'Cristãos e Muçulmanos passaram uns 800 anos lado a lado, umas vezes em paz, outras vezes em ___.', blank: 'conflito', options: ['conflito', 'música', 'desporto', 'viagens'], emoji: '⚔️', hint: 'O oposto de paz.' },
      { sentence: 'Os Muçulmanos deixaram-nos monumentos, muitas palavras e novas formas de fazer ___.', blank: 'agricultura', options: ['agricultura', 'pesca', 'caça', 'mineração'], emoji: '🌾', hint: 'Trouxeram novos sistemas de rega.' },
    ],
    timelineEvents: [
  ...
  formacaoPortugal: {
    ...
    quizQuestions: [
      { question: 'Com que batalha, no ano 722, começou a Reconquista Cristã?', options: ['Batalha de Covadonga', 'Batalha de Ourique', 'Batalha de Aljubarrota', 'Batalha de S. Mamede'], correct: 0, emoji: '⚔️', hint: 'Aconteceu nas Astúrias, no norte de Espanha.' },
    ...
    completeSentences: [
      { sentence: 'A Reconquista Cristã começou em 722, quando os cristãos venceram a Batalha de ___.', blank: 'Covadonga', options: ['Covadonga', 'Ourique', 'Aljubarrota', 'Alcanises'], emoji: '⚔️', hint: 'Aconteceu nas Astúrias.' },
      ...
      { sentence: 'Em 1297, Portugal e Castela assinaram um acordo que fixou a fronteira a leste: o Tratado de ___.', blank: 'Alcanises', options: ['Alcanises', 'Tordesilhas', 'Zamora', 'Windsor'], emoji: '📜', hint: 'Assinado entre os reis de Portugal e de Castela.' },
    ],
    timelineEvents: [
  ...
  portugalXIII_XIV: {
    ...
    completeSentences: [
      { sentence: 'Naquela época as pessoas dividiam-se em 3 grupos: nobreza, clero e ___.', blank: 'povo', options: ['povo', 'exército', 'clero', 'rei'], emoji: '🌾', hint: 'Era o grupo não privilegiado.' },
      { sentence: 'Nos concelhos, o povo tinha mais direitos, escritos num documento chamado carta de ___.', blank: 'foral', options: ['foral', 'lei', 'cortes', 'tratado'], emoji: '📜', hint: 'Documento próprio de um concelho.' },
  ...
  uniaoIberica: {
    ...
    translations: {
      'união ibérica': 'os 60 anos em que Portugal e Espanha foram governados pelo mesmo rei',
    ...
    quizQuestions: [
      ...
      { question: 'Como se chamam os 60 anos em que Portugal e Espanha foram governados pelo mesmo rei?', options: ['União Ibérica', 'Reconquista', 'Romanização', 'Expansão'], correct: 0, emoji: '🤝', hint: 'Junta os dois reinos da Península.' },
    ...
    completeSentences: [
      ...
      { sentence: 'Quando D. João IV foi aclamado rei, começou uma nova dinastia: a de ___.', blank: 'Bragança', options: ['Bragança', 'Avis', 'Borgonha', 'Áustria'], emoji: '👑', hint: 'Era Duque desse título antes de ser rei.' },
    ],
    timelineEvents: [
